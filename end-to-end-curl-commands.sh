...
curl -X POST -d '{"TestName": "demo4", "TestConfig":{"event_gen_options":{"invalid":false}, "type":"Performance", "performance_options": {"num_files_per_sec":500, "total_jobs":5000, "shard":true}}}' -H 'Content-Type: application/json' 'http://127.0.0.1:8800/startTest'