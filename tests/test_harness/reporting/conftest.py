...
def validity_df() -> pd.DataFrame:
    ...
    """
    data = [
        ["job_1", "job_name", True, "ValidSols", "file_1"],
        ["job_2", "job_name", True, "ValidSols", "file_2"],
        ["job_3", "job_name", False, "StackedSols", "file_3"],
        ["job_4", "job_name", False, "ANDConstraintBreak", "file_4"],
...
def pv_results_df() -> pd.DataFrame:
    ...
    results_df = pd.DataFrame(
        data=data, columns=["JobId", "FailureReason", "PVResult"]
    )
...
def expected_junit_string() -> str:
    ...
    return (
        ...
        ' tests="5" failures="1" errors="2">\n        <testsuite'
        ' name="job_name.False" tests="3" failures="0" errors="2">\n          '
        '  <testsuite name="job_name.False.ANDConstraintBreak" tests="1"'
        ' failures="0" errors="1">\n                <testcase'
        ' name="JobId=job_4, FileName=file_4"'
        ' classname="job_name.False.ANDConstraintBreak">\n                   '
        ' <error message="SVDC Success and PV failure" type="PVMisMatch">\n   '
        "                     Protocol Verifier showed success and failure"
        " messages. PV Failure reasons below:\n                            It"
        " Failed;\n                    </error>\n                </testcase>\n"
        "            </testsuite>\n            <testsuite"
        ' name="job_name.False.MissingEdges" tests="1" failures="0"'
        ' errors="1">\n                <testcase name="JobId=job_5,'
        ' FileName=file_5" classname="job_name.False.MissingEdges">\n         '
        ...
        ' errors="0">\n                <testcase name="JobId=job_3,'
        ' FileName=file_3" classname="job_name.False.StackedSols" />\n        '
        "    </testsuite>\n        </testsuite>\n        <testsuite"
        ' name="job_name.True" tests="2" failures="1" errors="0">\n           '
        ' <testsuite name="job_name.True.ValidSols" tests="2" failures="1"'
        ' errors="0">\n                <testcase name="JobId=job_1,'
        ' FileName=file_1" classname="job_name.True.ValidSols" />\n           '
        '     <testcase name="JobId=job_2, FileName=file_2"'
        ' classname="job_name.True.ValidSols">\n                    <failure'
        ' message="PV Result does not match validity" type="AssertionError">\n'
        "                        PV Result was a fail when sequence is valid."
        " PV failure reasons below:\n                            It Failed;\n "
        "                   </failure>\n                </testcase>\n         "
        "   </testsuite>\n        </testsuite>\n   "
        " </testsuite>\n</testsuites>"
    )
